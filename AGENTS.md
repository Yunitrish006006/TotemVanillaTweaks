...
## Observer UI ownership after extraction
...
- TotemObserver owns session/capability negotiation, server validation,
...
- Observer runtime validation belongs to TotemObserver. Every family requires
  unit tests, integrated loopback, Client GameTest visual
