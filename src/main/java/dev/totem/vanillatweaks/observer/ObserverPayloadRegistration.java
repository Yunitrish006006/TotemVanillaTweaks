...
/** Owns all server/common packet registration for the Observer subsystem. */
public final class ObserverPayloadRegistration {
    private ObserverPayloadRegistration() {}
