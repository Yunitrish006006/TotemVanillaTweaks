...
目前候選版本為 **0.1.4**，精確搭配 TotemCore **0.3.0**。
...
選擇。使用 DeadRecall 2.4.6 整合 JAR 時不要再安裝獨立
TotemVanillaTweaks。
...
0.1.4 已通過 13/13 required Fabric GameTests，涵蓋 lectern recipe、
