...
core_jar="$core/build/libs/totem-core-0.7.16.jar"
...
assert_checkout TotemCore b0b57bc98a98140a1c12a660a33952ea61167278 0.7.16
...
assert_checkout TotemNexus 781c4593b03c6d620c5bca575a69053612aef240 0.3.13
...
assert_production_jar "$core_jar" totem-core 0.7.16
...
"$wrapper" -p "$lockstep_root/TotemNexus" \
  -PtotemCoreJar="$core_jar" jar --no-daemon --stacktrace
assert_production_jar \
  "$lockstep_root/TotemNexus/build/libs/totem-nexus-0.3.13.jar" \
  totem-nexus 0.3.13
